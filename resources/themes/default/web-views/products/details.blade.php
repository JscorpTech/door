                                ...
                                <div class="cz-preview">
                                    <div id="sync1" class="owl-carousel owl-theme product-thumbnail-slider">
                                        @if($product->images!=null && json_decode($product->images)>0)
                                            ...
                                            @else
                                                @foreach ($product->color_images_full_url as $key => $photo)
                                                    <div class="product-color-preview d-flex align-items-center justify-content-center {{$key==0?'active':''}}"
                                                        id="colorImage{{$key}}">
                                                        <img class="color-image-zoom img-responsive w-100"
                                                            src="{{ getStorageImages($photo, type: 'product') }}"
                                                            data-zoom="{{ getStorageImages($photo, type: 'product') }}"
                                                        ...
                                                        <div class="color-image-zoom-pane"></div>
                                                    </div>
                                                @endforeach
