        ...
        <div class="col-lg-4 d-flex flex-column gap-3">
            ...
            <div class="card">
                <div class="card-body text-capitalize d-flex flex-column gap-4">
                    ...
                    <div class="">
                        <label
                            class="font-weight-bold title-color fz-14">{{translate('admin_confirmation_status')}}</label>
                        <select name="admin_confirmation_status" id="admin_confirmation_status"
                            class="status form-control" data-id="{{$order['id']}}">
                            <option
                                value="pending" {{$order->admin_confirmation_status == 'pending'?'selected':''}}> {{translate('pending')}}</option>
                            <option
                                value="confirmed" {{$order->admin_confirmation_status == 'confirmed'?'selected':''}}> {{translate('confirmed')}}</option>
                            <option
                                value="not_confirmed" {{$order->admin_confirmation_status == 'not_confirmed'?'selected':''}}> {{translate('not_confirmed')}}</option>
                        </select>
                    </div>
                    <div
            ...
            @if(!$order->is_guest && $order->customer && auth("admin")->check())
            <div class="card">
                <div class="card-body">
                    <div class="d-flex gap-2 align-items-center justify-content-between mb-4">
                        <h4 class="d-flex gap-2">
            ...
            @if($physicalProduct)
            <div class="card">
                @if($shippingAddress && auth("admin")->check())
                <div class="card-body">
                    <div class="d-flex gap-2 align-items-center justify-content-between mb-4">
                        <h4 class="d-flex gap-2">
                            <img
