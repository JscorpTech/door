                    ...
                    <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100 text-start">
                        <thead class="thead-light thead-50 text-capitalize">
                            <tr>
                                ...
                                <th class="text-capitalize">{{translate('admin_confirmation_status')}}</th>
                                @if($status == 'all')
                        ...
                        <tbody>
                            ...
                            <tr class="status-{{$order['order_status']}} class-all">
                                ...
                                <td class="text-center text-capitalize">
                                    @if($order['admin_confirmation_status']=='pending')
                                    <span class="badge badge-soft-info fz-12">
                                        {{translate($order['admin_confirmation_status'])}}
                                    </span>
                                    @elseif($order['admin_confirmation_status']=='confirmed')
                                    <span class="badge badge-soft-success fz-12">
                                        {{translate($order['admin_confirmation_status'])}}
                                    </span>
                                    @elseif($order['admin_confirmation_status']=='not_confirmed')
