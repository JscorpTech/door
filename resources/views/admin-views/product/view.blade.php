                        ...
                        <div class="d-block flex-grow-1 w-max-md-100">
                                ...
                                @if ($product['added_by'] == 'seller' && $product['request_status'] == 2)
                                    <div class="d-flex justify-content-sm-end flex-wrap gap-2 pb-4">
                                        <div>
                                            ...
                                            <span
                                                class="__badge badge badge-soft-danger">{{ translate('rejected') }}</span>
                                        </div>
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="d-block mt-2">
                                @foreach ($languages as $language)
                                    ...
                                    ?>
                                    <div class="{{ $language != 'en' ? 'd-none' : '' }} lang-form"
                                        id="{{ $language }}-form">
                                        <div class="d-flex">
                                        ...
                                        <div class="">
                                            <label
                                                class="text-gulf-blue font-weight-bold">{{ translate('description') . ' : ' }}</label>
                ...
                <div class="d-flex gap-3 flex-wrap">
                    ...
                    <div class="row gy-3 flex-grow-1">
                        <div class="col-sm-6 col-xl-4">
                            ...
                            <div class="pair-list">
                                <div>
                                    <span class="key text-nowrap">{{ translate('shop name') }}</span>
                                    <span>:</span>
                                    <span class="value">
                                        <a href="{{ route('admin.vendors.view', ['id' => $product->seller->shop->id]) }}">
                                ...
                                @if ($product->product_type == 'physical')
                                    <div>
                                        <span
                                            class="key text-nowrap text-capitalize">{{ translate('product_unit') }}</span>
                                        <span>:</span>
                        ...
                        <div class="col-sm-6 col-xl-4">
                            ...
                            <div class="pair-list">
                                ...
                                @if ($product->product_type == 'physical')
                                    <div>
                                        <span
                                            class="key text-nowrap text-capitalize">{{ translate('shipping_cost') }}</span>
                                        <span>:</span>
                                        <span class="value">
