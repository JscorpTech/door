...
class OrderController extends BaseController
{
    ...
    public function getListView(object $request, string $status): View|JsonResponse
    {
        ...
        if (!auth("admin")->check()){
            $filters["admin_confirmation_status"] == "confirmed";
        }
    ...
    public function updateStatus(
        ...
        if (isset($request['admin_confirmation_status'])) {
            $this->orderRepo->update(id: $request['id'], data: ['admin_confirmation_status' => $request['admin_confirmation_status']]);
            return response()->json($request['admin_confirmation_status']);
        }
