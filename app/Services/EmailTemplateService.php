...
class EmailTemplateService
{
    ...
    public function getTitleData(string $userType, $templateName): string
    {
        $titleData =  [
            ...
            EmailTemplateKey::WHOLESALE => 'New Order Wholesale',
    ...
    public function getBodyData(string $userType, $templateName): string
    {
        ...
        $bodyData =  [
            ...
            EmailTemplateKey::WHOLESALE => '<p><b>Hi ' . $userType . ',</b></p><p>Sizga yangi optom narxda buyurtma borligi haqida xabar berish uchun ushbu xatni yubordik. Panelga kirganingizdan so‘ng buyurtmalaringizni ko‘rishingiz mumkin bo‘ladi..</p>',
